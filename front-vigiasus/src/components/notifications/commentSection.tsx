...
import { Notification, Comment, notificationsData } from "@/constants/notificationsData";
...
console.log(notificationsData);
  ...
  export default function CommentSection({ notification }: NotificationProps) {
    ...
    const handleMarkAsRead = () => {
      ...
      // Add a new comment as if sent by the user
      const now = new Date();
  ...
  <div className="flex-1 p-6 flex flex-col gap-4 overflow-y-auto scrollbar-custom max-h-[60vh]">
        ...
        <div className="p-4 border-t border-gray-200 flex justify-end">
          <button
            ...
            className="px-6 py-3 cursor-pointer bg-green-500 text-white font-semibold rounded-full hover:bg-green-600 transition flex items-center gap-2"
          >
