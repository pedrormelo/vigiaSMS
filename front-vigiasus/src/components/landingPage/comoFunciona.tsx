...
function FeatureCard({ icon, title, description, className, style }: FeatureCardProps) {
  return (
    <div 
      className={`
        bg-white rounded-2xl p-4 md:p-8 shadow-lg
    ...
    >
      ...
      <div className="bg-gradient-to-br from-cyan-400 to-blue-600 p-2 md:p-3 rounded-2xl mb-3 md:mb-6 shadow-md">
        {icon}
      </div>
      
      {/* Título e descrição do card */}
      <h3 className="font-bold text-base md:text-lg text-blue-800 mb-2">{title}</h3>
    ...
    <section className="bg-white py-12 md:py-20 px-4 md:px-6">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center mb-8 md:mb-12">
          ...
          <p className="mt-2 md:mt-4 text-sm md:text-lg text-gray-500">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-8">
          <FeatureCard
            icon={<Database className="size-6 md:size-8 text-white" />}
          ...
          />
          <FeatureCard
            icon={<BarChart3 className="size-6 md:size-8 text-white" />}
          ...
          />
          <FeatureCard
            icon={<FileCheck2 className="size-6 md:size-8 text-white" />}
