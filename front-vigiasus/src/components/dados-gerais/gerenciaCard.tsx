...
export default function GerenciaCard({
  ...
  return (
    <div
      onClick={onClick}
      className={clsx(
        "flex h-full w-full max-h-3x cursor-pointer items-center overflow-hidden rounded-3xl bg-white hover:bg-gray-100/25 hover:text-gray-800 shadow-md border border-[#e4e4e4] transition hover:shadow-lg",
