...
const initialSampleFiles: DetalhesContexto[] = [
    ...
    { id: "7", title: "Apresentação de Resultados 2025", type: "apresentacao", insertedDate: "2025-09-05", url: "/docs/mock_resultados_2025.pptx", description: "Slides com os principais resultados do quadrimestre.", solicitante: "Equipe Planejamento", autor: "GPU", versoes: [{ id: 1, nome: "Resultados 2025 (v1).pptx", data: "2025-09-05", autor: "GPU", estaOculta: false }] },
