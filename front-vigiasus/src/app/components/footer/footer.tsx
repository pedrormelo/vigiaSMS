    ...
    <footer className="bg-white border-t border-blue-200">
      <div className="container mx-auto grid grid-cols-3 items-center py-4 px-4">
        ...
        <div className="flex justify-start">
          <Image
            src="/logos/artefato-prefeitura.png"
      ...
      {/* Texto institucional */}
      <div className="border-t border-blue-300 py-3 px-4 text-center text-xs md:text-sm text-gray-700">
        <p>
          ...
          <span className="text-blue-700">
            ...
            Secretaria Municipal de Saúde de Jaboatão dos Guararapes. Av. Barreto
            de Menezes, S/N – Prazeres – Jaboatão dos Guararapes – PE. CEP:
            54.330-900 – CNPJ: 03.904.395/0001-45 – Julho de 2025 – Ver: 1.0
          </span>
        </p>
      </div>
    </footer>
