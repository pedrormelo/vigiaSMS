   ...
   <div className="space-y-8">
        ...
        <section className="prose max-w-none text-gray-700 space-y-4">
            ...
            <ol className="list-decimal pl-5 space-y-3">
                ...
                <li><strong>Escolha o Tipo de Gráfico:</strong> Selecione entre Pizza (<PieChart className="inline w-4 h-4 mx-1"/>), Barras (<BarChart3 className="inline w-4 h-4 mx-1"/>) ou Área/Linha (<AreaChart className="inline w-4 h-4 mx-1"/>). A estrutura da tabela de dados se ajustará ligeiramente.<br/><span className="text-xs italic text-gray-500">[IMAGEM: Seletor de tipo de gráfico destacando as opções Pizza, Barras e Área]</span></li>
