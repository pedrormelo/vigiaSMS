...
// *** VERSÃO CORRIGIDA: Todos os campos 'gerencia' usam o ID (ex: "g6") ***
...
import { NomeIcone, ConjuntoDeDadosGrafico, TipoGrafico } from "@/components/popups/addContextoModal/types";
...
export const allContextosMock: Contexto[] = [
    ...
    },
    {
        ...
        type: "doc",
        gerencia: "g6", // <-- CORRIGIDO (Mapeado de 'Coordenação de Ouvidoria')
    ...
    // --- Contextos "Fechados" (Origem: contextosHistorico.ts) ---
     {
      ...
      },
      {
        ...
        status: StatusContexto.Publicado,
        type: "doc",
        gerencia: "g6", // <-- CORRIGIDO (Mapeado de 'Ouvidoria')
   ...
   // --- Indicadores (Origem: gerencia/[id]/page.tsx indicators) ---
    ...
    // (g7) Gerência de Tecnologia da Informação
    {
        ...
        estaOculto: false,
        historico: histPublicadoSimples,
        versoes: [{ id: 1, nome: "v1", data: "2024-01-15", autor: "Equipe GTI (g7)", status: StatusContexto.Publicado, historico: histPublicadoSimples }],
        payload: {
            colunas: ["Unidade", "Servidores", "Computadores"],
            linhas: [
            ...
            cores: ["#3B82F6", "#60A5FA", "#93C5FD", "#C3DAFE", "#DBEAFE"],
        }
    },
    {
        id: "graph-2",
        ...
        estaOculto: false,
        historico: histPublicadoSimples,
        versoes: [{ id: 1, nome: "v1", data: "2024-01-10", autor: "Equipe GTI (g7)", status: StatusContexto.Publicado, historico: histPublicadoSimples }],
        payload: {
            colunas: ["Status", "Unidades"],
            linhas: [
                ["Implementado", 75],
                ["Em Implementação", 15],
                ["Planejado", 10],
            ],
            cores: ["#22C55E", "#86EFAC", "#FEF3C7"],
        }
    },
    {
        id: "graph-3",
        ...
        estaOculto: false,
        historico: histPublicadoSimples,
        versoes: [{ id: 1, nome: "v1", data: "2024-01-20", autor: "Equipe GTI (g7)", status: StatusContexto.Publicado, historico: histPublicadoSimples }],
        payload: {
            colunas: ["Mês", "Abertos", "Resolvidos", "Pendentes"],
            linhas: [
                ["Jan", 150, 140, 10],
                ["Fev", 180, 175, 15],
                ["Mar", 165, 160, 20],
    ...
    },
    {
        ...
        estaOculto: false,
        historico: histPublicadoSimples,
        versoes: [{ id: 1, nome: "v1", data: "2024-02-01", autor: "Equipe GTI (g7)", status: StatusContexto.Publicado, historico: histPublicadoSimples }],
        payload: {
            colunas: ["Servidor", "Usado (%)", "Disponível (%)"],
            linhas: [
                ["Servidor Principal", 65, 35],
                ["Servidor Backup", 40, 60],
                ["Servidor Web", 80, 20],
            ],
            cores: undefined, // Usará o padrão
        }
    },
    {
        id: "graph-5",
        ...
        estaOculto: false,
        historico: histPublicadoSimples,
        versoes: [{ id: 1, nome: "v1", data: "2024-02-05", autor: "Equipe GTI (g7)", status: StatusContexto.Publicado, historico: histPublicadoSimples }],
        payload: {
            colunas: ["Sistema", "PEC", "SISREG", "Portal"],
            linhas: [
    ...
    // (g6) Gerência de Planejamento
    {
        ...
        estaOculto: false,
        historico: histPublicadoSimples,
        versoes: [{ id: 1, nome: "v1", data: "2024-01-25", autor: "Equipe GPLAN (g6)", status: StatusContexto.Publicado, historico: histPublicadoSimples }],
        payload: {
            colunas: ["Programa", "Orçamento (M)"],
            linhas: [
                ["Atenção Básica", 45],
    ...
    },
    {
        ...
        estaOculto: false,
        historico: histPublicadoSimples,
        versoes: [{ id: 1, nome: "v1", data: "2024-02-10", autor: "Equipe GPLAN (g6)", status: StatusContexto.Publicado, historico: histPublicadoSimples }],
        payload: {
            colunas: ["Trimestre", "Previsto", "Executado"],
            linhas: [
                ["1º Tri", 25, 23],
                ["2º Tri", 30, 28],
                ["3º Tri", 25, 26],
    ...
    {
        id: "graph-8",
        title: "Indicadores de Saúde (GPLAN)",
        type: "dashboard",
        chartType: "line",
        ...
        estaOculto: false,
        historico: histPublicadoSimples,
        versoes: [{ id: 1, nome: "v1", data: "2024-02-15", autor: "Equipe GPLAN (g6)", status: StatusContexto.Publicado, historico: histPublicadoSimples }],
        payload: {
            colunas: ["Indicador", "Meta", "Realizado"],
            linhas: [
                ["Cobertura ESF", 85, 82],
                ["Vacinação", 50, 88],
                ["Pré-natal", 30, 95],
    ...
    // (g2) Gerência de Atenção Básica
    {
        ...
        estaOculto: false,
        historico: histPublicadoSimples,
        versoes: [{ id: 1, nome: "v1", data: "2024-01-30", autor: "Equipe GAB (g2)", status: StatusContexto.Publicado, historico: histPublicadoSimples }],
        payload: {
            colunas: ["Distrito", "Cobertura (%)"],
            linhas: [
                ["Norte", 85],
                ["Sul", 78],
                ["Leste", 82],
    ...
    {
        id: "graph-10",
        title: "Atendimentos por Tipo (Atenção Básica)",
        type: "dashboard",
        chartType: "pie",
        insertedDate: "2024-02-05",
        status: StatusContexto.Publicado,
        ...
        estaOculto: false,
        historico: histPublicadoSimples,
        versoes: [{ id: 1, nome: "v1", data: "2024-02-05", autor: "Equipe GAB (g2)", status: StatusContexto.Publicado, historico: histPublicadoSimples }],
        payload: {
            colunas: ["Tipo", "Atendimentos"],
            linhas: [
                ["Consulta Médica", 45],
    ...
    // (g4) Gerência de Regulação Ambulatorial
    {
        ...
        estaOculto: false,
        historico: histPublicadoSimples,
        versoes: [{ id: 1, nome: "v1", data: "2024-02-08", autor: "Equipe GRA (g4)", status: StatusContexto.Publicado, historico: histPublicadoSimples }],
        payload: {
            colunas: ["Especialidade", "Aguardando"],
            linhas: [
                ["Cardiologia", 150],
                ["Ortopedia", 120],
                ["Neurologia", 80],
    ...
    {
        id: "graph-12",
        title: "Tempo Médio de Espera (Regulação)",
        type: "dashboard",
        chartType: "line",
        ...
        estaOculto: false,
        historico: histPublicadoSimples,
        versoes: [{ id: 1, nome: "v1", data: "2024-02-12", autor: "Equipe GRA (g4)", status: StatusContexto.Publicado, historico: histPublicadoSimples }],
        payload: {
            colunas: ["Mês", "Cardiologia", "Ortopedia", "Neurologia"],
            linhas: [
                ["Jan", 45, 60, 30],
                ["Fev", 42, 55, 28],
                ["Mar", 38, 50, 25],
